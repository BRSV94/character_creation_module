...
def attack(char_name: str, char_class: str) -> str:
    """
    This function returns the amount of damage dealt by an attack.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    This function returns the amount of damage reflected by using a defence.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    This function returns the result of applying a special skill.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Function for training character skills.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    This function determines the class of the character.
    """
    approve_choice: str = ''
    char_class: str = ''
